...
import com.javamsdt.locals3.configuration.S3TestConfiguration;
...
class SimpleS3UploadTest {
    ...
    void uploadFileToS3() {
        // createBucket(s3TestClient, BUCKET_NAME);
         generateBucket(s3TestClient, BUCKET_NAME);
    ...
    private void generateBucket(S3Client s3Client, String bucketName) {
        try {
            ...
            System.out.println("bucketRequest.bucket():: " + bucketRequest.bucket());
